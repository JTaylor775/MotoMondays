...
namespace MotoMondays.Controllers
{
    public class PartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PartID,PartName,InStock")] Part part)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PartID,PartName,InStock")] Part part)
        {
            if (id != part.PartID)
            {
                return NotFound();
